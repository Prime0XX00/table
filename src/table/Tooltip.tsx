	...
	useEffect(() => {
		...
		const top =
			placement === "top"
				...
				: triggerRect.top + triggerRect.height + 6 + window.scrollY;
			...
			{visible &&
				createPortal(
					<div
						ref={tooltipRef}
						role="tooltip"
						className="z-100 py-1 px-2 rounded-sm bg-tooltip text-tooltip-text absolute shadow-lg text-sm pointer-events-none"
